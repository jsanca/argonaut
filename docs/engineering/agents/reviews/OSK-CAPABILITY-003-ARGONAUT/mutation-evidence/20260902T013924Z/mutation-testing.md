# Mutation Testing Evidence — OSK-CAPABILITY-003-ARGONAUT
...
- Started (UTC): 2026-09-02T01:39:24Z
- Ended (UTC): 2026-09-02T01:39:28Z
...
- Working-tree status: [raw](raw/working-tree-status.txt) SHA-256 73f279ef340b569e71f24f1607698743c3150a7824117d7fdd36d748124124cc
...
| --- | --- | --- | --- | --- | --- | --- |
| `core-metrics` | argonaut-core package dev.jsanca.argonaut.core.metrics and its matching tests; bounded experimental mutation analysis | `project-selected-java-mutation-provider/maven-plugin` | `FAIL` | 4s | — | — |
